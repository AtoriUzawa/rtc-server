...
// Module bundles the P2P HTTP handler and WebSocket handler.
type Module struct {
	Handler   *Handler
	WSHandler *WSHandler
}

// New creates a new P2P module with its manager, service, and handlers.
...
// RegisterHTTP registers HTTP routes for the P2P module.
func (m *Module) RegisterHTTP(r *gin.RouterGroup) {
	RegisterRouter(r, m.Handler)
}

// RegisterWS registers WebSocket routes for the P2P module.
